        ...
        <div class="rounded-xl bg-white dark:bg-slate-800 py-12">
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div
                        class="bg-gray-100 dark:bg-slate-900 p-4 text-left border rounded-xl border-gray-100 dark:border-none">
                ...
                <div
                    class="bg-gray-100 mt-4 dark:bg-slate-900 p-4 text-left border rounded-xl border-gray-100 dark:border-none">
                    <div class="text-gray-800 dark:text-slate-200 text-[16px] sm:text-lg  lg:text-xl text-xl mb-1">{{
                        mainText?.text_9 }}</div>
                </div>
